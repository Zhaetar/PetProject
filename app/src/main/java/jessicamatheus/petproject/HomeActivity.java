    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        levelButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) { //Ao clicar no botão..
                ...
                //showAlertDialog();
                scheduleNotification(HomeActivity.this, 5000, 1);
...
///// CLASSES DE FOTO
    ...
    public void scheduleNotification(Context context, long delay, int notificationId) {//delay is after how much time(in millis) from current time you want to schedule the notification
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setContentTitle("Pet Pet")
                .setContentText("Your pet requires your attention!")
        ...
        Intent intent = new Intent(context, HomeActivity.class).putExtra("showAlertDialog", 5);
        ...
        //--Acima é repetir, abaixo é só um alarme.
